...
id: code-reviews
title: Code Reviews
description: Code reviews not only need to be given effectively, it is also important to know how to receive them well
keywords:
  [
    code reviews,
    code review,
...
image: https://software-engineering-excellence.vercel.app/img/undraw_code_reviews.svg
---
