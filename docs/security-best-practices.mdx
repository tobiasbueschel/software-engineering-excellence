...
description: >-
  Protect applications from common vulnerabilities with secure coding practices, authentication patterns, and
...
image: >-
  https://software-engineering-excellence.vercel.app/img/social/undraw_security_on.png
---

import SecurityBestPracticesImage from '/img/undraw_security_on.svg';

<div className="text--center margin-bottom--lg">
  <SecurityBestPracticesImage width="80%" height="300px" />
</div>
...
:::tip Security is Everyone's Responsibility

Security isn't just the security team's job. Every developer, designer, and stakeholder must consider security
