...
description: >-
  Standards-aligned guidance for building consistent, predictable HTTP APIs with proper naming, status codes, and
  pagination.
keywords:
  - REST API
  - RESTful
  ...
  - pagination
  - resource naming
image: 'https://software-engineering-excellence.vercel.app/img/social/undraw_api.png'
---

import RestAPIImage from '/img/undraw_api.svg';
