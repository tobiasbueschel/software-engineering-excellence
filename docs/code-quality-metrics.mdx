...
description: >-
  Track code quality with quantifiable metrics like cyclomatic complexity, code coverage, and maintainability indices to
...
keywords:
  ...
  - SonarQube
image: >-
  https://software-engineering-excellence.vercel.app/img/social/undraw_analytics.png
---

import CodeQualityMetricsImage from '/img/undraw_analytics.svg';

<div className="text--center margin-bottom--lg">
  <CodeQualityMetricsImage width="80%" height="300px" />
</div>
