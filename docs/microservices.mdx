...
:::warning Starting with microservices adds significant operational complexity. Consider beginning with a
well-structured monolith and extracting services as needs become clear. :::
