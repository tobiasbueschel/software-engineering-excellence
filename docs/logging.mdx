...
import LoggingImage from '/img/undraw_bug_fixing.svg';
...
:::caution Performance Impact TRACE logging can significantly impact performance. Only use in non-production
environments or enable temporarily for specific debugging scenarios. :::
